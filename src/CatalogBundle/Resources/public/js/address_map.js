...
AddressMap.prototype.init = function() {
    ...
    if (typeof google === 'object' && typeof google.maps === 'object') {
        ...
        script.src = (this.settings.secure ? 'https' : 'http' ) + '://maps.google.com/maps/api/js?v=3.25&key=' + this.settings.googleApiKey + '&callback=' + this.settings.googleMapsLoadedCallback+'&language=en';
...
AddressMap.prototype.handleGoogleMapApiReady = function() {
    this.geocoder = new google.maps.Geocoder({language:'en'});

    var center = new google.maps.LatLng(this.settings.defaultLat, this.settings.defaultLng);
    var mapOptions = {
        zoom: 12, //this.settings.defaultZoom,
        center: center,
        scrollwheel: true,
