        ...
        return this.each( function() {
			...
			$(this).on("mousemove", function(event){
			  ...
			  $(this).on("mouseleave", function(event){
				...
				var imageCounterSelector = '#' + $(this).attr('id') + '-imgCounter';
			  	if ($(imageCounterSelector).length) { $(imageCounterSelector).html(1); }
			  });
			      ...
			      function showMouseX(e,that){
					...
					var imageCounterSelector = '#' + that + '-imgCounter';
					if ($(imageCounterSelector).length) { $(imageCounterSelector).html(imgNum+1); }
